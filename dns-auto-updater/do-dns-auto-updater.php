 ...
 * source: https://github.com/bensquire/Digital-Ocean-Dynamic-DNS-Updater
 *
 * @param $url string
 *
 * @return mixed
...
try {
    ...
    DEFINE('ACCESS_TOKEN', 'dop_v1_0b5c27f6d1b09606385faba418b8afef1c6269cf4992f90c43bb3424eb4408f3');
    DEFINE('DOMAIN', 'dev4io.net');
    DEFINE('RECORD', 'connect-dev-server');
    DEFINE('RTYPE', 'A');
